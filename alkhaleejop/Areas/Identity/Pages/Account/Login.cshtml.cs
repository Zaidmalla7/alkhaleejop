...
namespace alkhaleejop.Areas.Identity.Pages.Account;
...
public class LoginModel : PageModel
{
    ...
    public async Task<IActionResult> OnPostAsync(string? returnUrl = null)
    {
        ...
        {
            // تم تغيير Input.RememberMe إلى isPersistent: true
            ...
            {
                // هون كمان غيرناها لـ true عشان لو عنده توثيق ثنائي يضل متذكره
